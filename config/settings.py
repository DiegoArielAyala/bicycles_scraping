...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'apps/scraping/static'),
]
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "bicycle@scraping.com")
...
GOOGLE_OAUTH_CALLBACK_URL = f"{FRONTEND_URL}/auth/google/callback/"
